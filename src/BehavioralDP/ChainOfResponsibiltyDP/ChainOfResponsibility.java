...
public class ChainOfResponsibility {
    ...
    void chainOfResponsibilityDemo(){
        ...
        System.out.println("Genel Müdür için maksimum : sınırsız");
        System.out.println("*****************************");
        System.out.println("Müşterinin memurdan istediği kredi miktarı : 50");
        memur.approveLoan(50);
        System.out.println("Müşterinin memurdan istediği kredi miktarı : 450");
        memur.approveLoan(450);
        System.out.println("Müşterinin memurdan istediği kredi miktarı : 1050");
